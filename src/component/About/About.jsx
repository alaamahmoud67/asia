          ...
          <div className="about-content">
            <div className="row">
              <div className="col-md-6">
                ...
                <div className="abot-icons ">
                  {/* first icon */}
                  <div
                    className="d-flex align-items-center   py-5 mb-3"
                    data-aos="fade-up ">
                  ...
                  <div
                    ...
                    data-aos="fade-up ">
                    <div className="img-icon">
                      <img src={second_icon} alt="" className="" />
                    </div>
                    <div className="content-text px-3">
                      <h6>Stats</h6>
                  ...
                  <div
                    ...
                    data-aos="fade-up ">
                    <div className="img-icon">
                      <img src={third_icon} alt="" className="" />
                    </div>
                    <div className="content-text px-3">
                      <h6>Clubs</h6>
              ...
              <div className="col-md-6 ">
                <div className="about-imge" data-aos="fade-up">
                  <div className=" position-relative   ">
                    <div className=" im ">
                      <img src={imgp3} alt="" className="w-100 h-100 p-lg-5 im" />
                    </div>
                  </div>
                </div>
              </div>
